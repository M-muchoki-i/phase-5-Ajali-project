...
export default function ReportForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const position = await getCurrentPosition(); // Assumes this returns a Promise with coords
  ...
  return (
    ...
    return (
        <>
          ...
          <button
            type="submit"
            className="w-full py-3 px-4 mt-4 bg-red-500 text-white font-medium rounded-lg hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 shadow-sm transition-all"
          >
            Submit Report
          </button>
        </form>
